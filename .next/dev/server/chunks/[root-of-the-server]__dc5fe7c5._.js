...
;
async function GET() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("campaigns").select("*").order("id", {
        ascending: false
    });
...
async function POST(request) {
    try {
        ...
        const server = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServerSupabaseClient"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc5fe7c5._.js.map